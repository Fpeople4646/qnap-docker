...
var volumeCmd = &cobra.Command{
	...
	Long:  `Manage Docker volumes on your QNAP NAS.`,
}

var volumeListCmd = &cobra.Command{
	Use:     "ls [OPTIONS]",
	Short:   "List volumes",
	Long:    `List Docker volumes on your QNAP NAS.`,
	RunE:    listVolumes,
	Aliases: []string{"list"},
}
...
var volumeCreateCmd = &cobra.Command{
	...
	Long:  `Create a Docker volume on your QNAP NAS.`,
	RunE:  createVolume,
}
...
var volumeRemoveCmd = &cobra.Command{
	...
	Long:    `Remove one or more Docker volumes from your QNAP NAS.`,
