...
var networkCmd = &cobra.Command{
	...
	Long:  `Manage Docker networks on your QNAP NAS.`,
}

var networkListCmd = &cobra.Command{
	Use:     "ls [OPTIONS]",
	Short:   "List networks",
	Long:    `List Docker networks on your QNAP NAS.`,
	RunE:    listNetworks,
	Aliases: []string{"list"},
}
...
var networkCreateCmd = &cobra.Command{
	...
	Long:  `Create a Docker network on your QNAP NAS.`,
...
var networkRemoveCmd = &cobra.Command{
	...
	Long:    `Remove one or more Docker networks from your QNAP NAS.`,
