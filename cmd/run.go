...
var runCmd = &cobra.Command{
	...
	Long: `Deploy a single Docker container to your QNAP NAS.
...
func runContainer(cmd *cobra.Command, args []string) error {
	...
	fmt.Printf("\nYou can check the status with: qnap-docker ps\n")
...
func init() {
	...
	runCmd.Flags().StringVar(&runRestart, "restart", qnap.DefaultRestartPolicy, "Restart policy (no, always, unless-stopped, on-failure)")
	runCmd.Flags().StringVar(&runNetwork, "network", qnap.DefaultNetwork, "Network mode")
