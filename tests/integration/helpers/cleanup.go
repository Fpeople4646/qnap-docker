...
func NewCleanupManager(conn *qnap.Connection) *CleanupManager {
...
// ForceCleanupContainers removes all containers with qnap-docker test prefix
func (cm *CleanupManager) ForceCleanupContainers() error {
	fmt.Println("Force cleaning up all qnap-docker test containers...")
