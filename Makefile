...
integration-test:
	...
	@if [ -z "$(NAS_HOST)" ]; then \
		...
		echo "Usage: NAS_HOST=your-qnap.local NAS_USER=admin make integration-test"; \
		exit 1; \
	fi
...
# Show help
help:
	@echo "QNAP-Docker Makefile Commands:"
	@echo ""
	@echo "Build Commands:"
	...
	@echo "  NAS_HOST    QNAP NAS IP for integration tests"
